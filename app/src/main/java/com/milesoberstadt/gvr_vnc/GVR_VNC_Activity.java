...
package com.milesoberstadt.gvr_vnc;
 ...
 */
public class GVR_VNC_Activity extends GvrActivity implements GvrView.StereoRenderer {

  protected float[] modelCube;
  protected float[] modelPosition;

  private static final String TAG = "GVR_VNC_Activity";
